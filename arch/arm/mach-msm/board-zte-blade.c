...
#endif /* #ifndef CONFIG_ZTE_PLATFORM */
...
#ifdef CONFIG_USB_ANDROID
static char VARIABLE_IS_NOT_USED *usb_functions_default[] = {
	"diag",
	"modem",
	"nmea",
	"rmnet",
...
static char VARIABLE_IS_NOT_USED *usb_functions_default_adb[] = {
	"diag",
	"adb",
	"modem",
	"nmea",
...
static char VARIABLE_IS_NOT_USED *usb_functions_rndis[] = {
	"rndis",
};

static char VARIABLE_IS_NOT_USED *usb_functions_rndis_adb[] = {
	"rndis",
	"adb",
};
...
static char VARIABLE_IS_NOT_USED *usb_functions_diag_modem_nmea_ms_adb_at[] = 
{
	"diag",
	"modem",
	"nmea",
...
static char VARIABLE_IS_NOT_USED *usb_function_ms_adb[] =
{
	"usb_mass_storage",
	"adb",
};
...
static char VARIABLE_IS_NOT_USED *usb_function_modem_ms_adb[]=
{"modem",
 "usb_mass_storage",
 "adb",
};
...
static char VARIABLE_IS_NOT_USED *usb_function_rndis_ms_adb[] =
{
	"rndis",
	"usb_mass_storage",
	"adb",
...
#endif /* #ifdef CONFIG_USB_ANDROID */
